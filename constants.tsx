...
export const SMM_SERVICES = [
  { category: 'Instagram', group: 'Social', icon: 'fa-brands fa-instagram', color: '#E1306C', items: [
    { id: '101', type: 'Followers', name: 'Instagram Real Followers [Refill 30D]', price: 2.90, per: 1000, speed: '20K/Day', min: 100, max: 500000, avgTime: '1 Hour', guarantee: '30 Days', provider: 'PeakSMM', region: 'Global', stability: 'Stable' },
    { id: '102', type: 'Followers', name: 'Instagram Followers [Brazil] - Real Active', price: 5.50, per: 1000, speed: '2K/Day', min: 100, max: 50000, avgTime: '3 Hours', guarantee: '30 Days', provider: 'LatamBoost', region: 'Brazil', stability: 'HQ' },
    { id: '103', type: 'Followers', name: 'Instagram Followers [USA] - High Quality', price: 8.90, per: 1000, speed: '1K/Day', min: 50, max: 2000, avgTime: '6 Hours', guarantee: 'Non-Drop', provider: 'USAGrowth', region: 'USA', stability: 'Premium' },
    { id: '104', type: 'Likes', name: 'Instagram Likes [Real HQ]', price: 0.95, per: 1000, speed: 'Instant', min: 50, max: 100000, avgTime: '5 Mins', guarantee: 'Lifetime', provider: 'TurboSMM', region: 'Global', stability: 'Fast' },
    { id: '107', type: 'Likes', name: 'Instagram Likes [Power Likes] - Monetizable', price: 4.20, per: 1000, speed: 'Fast', min: 50, max: 20000, avgTime: '10 Mins', guarantee: 'Non-Drop', provider: 'PeakSMM', region: 'Global', stability: 'HQ' },
    { id: '105', type: 'Comments', name: 'Instagram Comments [Custom]', price: 12.50, per: 1000, speed: 'Organic', min: 10, max: 5000, avgTime: '6 Hours', guarantee: 'Non-Drop', provider: 'SocialKing', region: 'Global', stability: 'Safe' },
    { id: '108', type: 'Comments', name: 'Instagram Comments [Verified Accounts]', price: 85.00, per: 1000, speed: 'Slow', min: 1, max: 100, avgTime: '12 Hours', guarantee: 'Permanent', provider: 'EliteNodes', region: 'Global', stability: 'Ultra' },
    { id: '106', type: 'Views', name: 'Instagram Reels Views [Viral Spread]', price: 0.20, per: 1000, speed: '1M/Day', min: 100, max: 10000000, avgTime: 'Instant', guarantee: 'Lifetime', provider: 'ViralNodes', region: 'Global', stability: 'Fast' },
    { id: '109', type: 'Views', name: 'Instagram Live Stream Views [60 Min]', price: 15.00, per: 1000, speed: 'Instant', min: 100, max: 5000, avgTime: '1 Min', guarantee: 'Active', provider: 'StreamSync', region: 'Global', stability: 'HQ' },
  ]},
  { category: 'Facebook', group: 'Social', icon: 'fa-brands fa-facebook', color: '#1877F2', items: [
    { id: '201', type: 'Followers', name: 'Facebook Page Likes + Followers', price: 4.50, per: 1000, speed: '5K/Day', min: 100, max: 200000, avgTime: '12 Hours', guarantee: '30 Days', provider: 'MetaPro', region: 'Global', stability: 'Stable' },
    { id: '202', type: 'Followers', name: 'Facebook Page Likes [Europe] - Real', price: 9.00, per: 1000, speed: '1K/Day', min: 100, max: 50000, avgTime: '24 Hours', guarantee: '30 Days', provider: 'EuroSocial', region: 'Europe', stability: 'HQ' },
    { id: '203', type: 'Likes', name: 'Facebook Post Likes [Global]', price: 1.20, per: 1000, speed: 'Instant', min: 50, max: 50000, avgTime: '10 Mins', guarantee: 'Non-Drop', provider: 'FastLikes', region: 'Global', stability: 'Fast' },
    { id: '206', type: 'Likes', name: 'Facebook Post Reactions [Love/Wow]', price: 1.80, per: 1000, speed: 'Instant', min: 50, max: 20000, avgTime: '15 Mins', guarantee: 'Lifetime', provider: 'PeakSMM', region: 'Global', stability: 'Stable' },
    { id: '204', type: 'Views', name: 'Facebook Video Views [Monetizable]', price: 2.80, per: 1000, speed: '50K/Day', min: 500, max: 1000000, avgTime: '24 Hours', guarantee: 'Lifetime', provider: 'MediaStream', region: 'Global', stability: 'HQ' },
    { id: '205', type: 'Members', name: 'Facebook Group Members [USA]', price: 6.50, per: 1000, speed: '500/Day', min: 100, max: 10000, avgTime: '48 Hours', guarantee: '30 Days', provider: 'USAGrowth', region: 'USA', stability: 'HQ' },
  ]},
  { category: 'TikTok', group: 'Social', icon: 'fa-brands fa-tiktok', color: '#000000', items: [
    { id: '301', type: 'Followers', name: 'TikTok Followers [Real Active]', price: 3.20, per: 1000, speed: '10K/Day', min: 100, max: 100000, avgTime: '4 Hours', guarantee: '30 Days', provider: 'TikViral', region: 'Global', stability: 'Stable' },
    { id: '302', type: 'Followers', name: 'TikTok Followers [Russia] - Real', price: 4.50, per: 1000, speed: '5K/Day', min: 100, max: 50000, avgTime: '6 Hours', guarantee: '30 Days', provider: 'RuGram', region: 'Russia', stability: 'HQ' },
    { id: '303', type: 'Likes', name: 'TikTok Likes [HQ]', price: 1.10, per: 1000, speed: 'Instant', min: 50, max: 500000, avgTime: '15 Mins', guarantee: 'Non-Drop', provider: 'TurboSMM', region: 'Global', stability: 'Fast' },
    { id: '304', type: 'Views', name: 'TikTok Views [Instant]', price: 0.05, per: 1000, speed: '10M/Day', min: 1000, max: 100000000, avgTime: 'Instant', guarantee: 'Lifetime', provider: 'ViralNodes', region: 'Global', stability: 'Fast' },
    { id: '306', type: 'Views', name: 'TikTok SEO Views - Key Search Result', price: 1.20, per: 1000, speed: '100K/Day', min: 100, max: 100000, avgTime: '4 Hours', guarantee: 'Lifetime', provider: 'SearchBoost', region: 'Global', stability: 'HQ' },
    { id: '305', type: 'Shares', name: 'TikTok Shares & Saves', price: 0.25, per: 1000, speed: 'Instant', min: 100, max: 500000, avgTime: 'Instant', guarantee: 'Lifetime', provider: 'TikViral', region: 'Global', stability: 'Fast' },
  ]},
  { category: 'YouTube', group: 'Social', icon: 'fa-brands fa-youtube', color: '#FF0000', items: [
    { id: '401', type: 'Subscribers', name: 'YouTube Subscribers [Non-Drop]', price: 22.00, per: 1000, speed: '200/Day', min: 50, max: 10000, avgTime: '24 Hours', guarantee: 'Lifetime', provider: 'TubeSync', region: 'Global', stability: 'Safe' },
    { id: '402', type: 'Watchtime', name: 'YouTube Watchtime [4000 Hours] - Pack', price: 45.00, per: 1000, speed: '300H/Day', min: 1000, max: 4000, avgTime: '48 Hours', guarantee: 'Refill', provider: 'MonetizeHQ', region: 'Global', stability: 'Ultra' },
    { id: '403', type: 'Views', name: 'YouTube High Retention Views', price: 3.50, per: 1000, speed: '10K/Day', min: 500, max: 1000000, avgTime: '2 Hours', guarantee: 'Lifetime', provider: 'TubeSync', region: 'Global', stability: 'Stable' },
  ]},
];
